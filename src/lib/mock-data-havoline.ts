...
export const topPosts: TopPostData[] = [
  ...
  { brand: "Castrol", network: "instagram", caption: "¡GANA UNA EXPERIENCIA DE F1 CON CASTROL! ¿Listo para sentirte como piloto de Fórmula 1?", likes: 5480, comments: 27, shares: 0, views: 0, date: "2026-04-21" },
  { brand: "Havoline", network: "facebook", caption: "Muchos creen que la seguridad depende solo del conductor, pero un buen parrillero también hace la diferencia.", likes: 3824, comments: 0, shares: 617, views: 0, date: "2026-07-24" },
  { brand: "Havoline", network: "facebook", caption: "La pelea entre carro y moto se volvió viral, y en los comentarios quedó claro: cada quien defiende su lado.", likes: 1853, comments: 0, shares: 194, views: 0, date: "2026-05-05" },
  { brand: "Liqui Moly", network: "facebook", caption: "¡No contamines el aceite nuevo de tu moto! Antes de hacer el cambio de aceite, aplica LIQUI MOLY Engine Flush para eliminar residuos...", likes: 1911, comments: 0, shares: 48, views: 0, date: "2026-08-10" },
  { brand: "Motul", network: "instagram", caption: "Lo que estás a punto de ver no es un viaje cualquiera, es una aventura de Guayaquil a Medellín con toda la potencia...", likes: 810, comments: 5, shares: 0, views: 0, date: "2026-05-18" },
];
