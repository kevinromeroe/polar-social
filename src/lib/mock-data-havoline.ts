...
export const topPosts: TopPostData[] = [
  { brand: "Havoline", network: "instagram", caption: "Muchos roces en la vía pasan por lo mismo: estar en el lugar donde nadie te ve. Rodar pegado a la puerta, quedarse en el punto ciego...", likes: 24154, comments: 1307, shares: 0, views: 0, date: "2026-03-18", url: "https://www.instagram.com/p/DWCrHQaDkM_/", imageUrl: `${IMG}/havoline-ig-puntos-ciegos.jpg` },
  { brand: "Havoline", network: "facebook", caption: "Muchos roces en la vía pasan por lo mismo: estar en el lugar donde nadie te ve. Rodar pegado a la puerta...", likes: 13446, comments: 0, shares: 5272, views: 0, date: "2026-03-18", url: "https://www.facebook.com/reel/1938988486714393/", imageUrl: `${IMG}/havoline-fb-puntos-ciegos.jpg` },
  { brand: "Mobil", network: "instagram", caption: "Por primera vez, un mismo apellido conquistó el podio del Gran Premio Mobil Delvac. Más que una victoria...", likes: 10906, comments: 31, shares: 0, views: 0, date: "2026-07-27", url: "https://www.instagram.com/p/DbTbeEDxNmm/", imageUrl: `${IMG}/mobil-ig-podio.jpg` },
  { brand: "Mobil", network: "instagram", caption: "La historia ya tiene a su primera campeona. Juliana Castelblanco Rueda conquistó la pista y se convirtió en la primera mujer en ganar...", likes: 7563, comments: 47, shares: 0, views: 0, date: "2026-07-28", url: "https://www.instagram.com/p/DbVukb0xXQY/", imageUrl: `${IMG}/mobil-ig-campeona.jpg` },
  { brand: "Castrol", network: "instagram", caption: "Lucas tiene claro el objetivo para 2026. Estuvimos con él en el Autódromo de Tocancipá hablando del plan, las carreras...", likes: 6708, comments: 4, shares: 0, views: 0, date: "2026-03-04", url: "https://www.instagram.com/p/DVefLpMjlCY/", imageUrl: `${IMG}/castrol-ig-lucas.jpg` },
  { brand: "Castrol", network: "instagram", caption: "¡GANA UNA EXPERIENCIA DE F1 CON CASTROL! ¿Listo para sentirte como piloto de Fórmula 1?", likes: 5480, comments: 27, shares: 0, views: 0, date: "2026-04-21", url: "https://www.instagram.com/p/DXaCfRiFECr/", imageUrl: `${IMG}/castrol-ig-f1.jpg` },
  { brand: "Havoline", network: "facebook", caption: "Muchos creen que la seguridad depende solo del conductor, pero un buen parrillero también hace la diferencia.", likes: 3824, comments: 0, shares: 617, views: 0, date: "2026-07-24", url: "https://www.facebook.com/reel/4316502191907113/", imageUrl: `${IMG}/havoline-fb-parrillero.jpg` },
  { brand: "Havoline", network: "facebook", caption: "La pelea entre carro y moto se volvió viral, y en los comentarios quedó claro: cada quien defiende su lado.", likes: 1853, comments: 0, shares: 194, views: 0, date: "2026-05-05", url: "https://www.facebook.com/reel/2268106087298540/", imageUrl: `${IMG}/havoline-fb-carro-moto.jpg` },
  { brand: "Liqui Moly", network: "facebook", caption: "¡No contamines el aceite nuevo de tu moto! Antes de hacer el cambio de aceite, aplica LIQUI MOLY Engine Flush para eliminar residuos...", likes: 1911, comments: 0, shares: 48, views: 0, date: "2026-08-10", url: "https://www.facebook.com/reel/1072988555068766/", imageUrl: `${IMG}/liquimoly-fb-flush.jpg` },
  { brand: "Motul", network: "instagram", caption: "Lo que estás a punto de ver no es un viaje cualquiera, es una aventura de Guayaquil a Medellín con toda la potencia...", likes: 810, comments: 5, shares: 0, views: 0, date: "2026-05-18", url: "https://www.instagram.com/p/DX-KbFopF3A/", imageUrl: `${IMG}/motul-ig-aventura.jpg` },
];
